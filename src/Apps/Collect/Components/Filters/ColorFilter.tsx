        ...
        >
          <g>
            ...
            <path
              fill="#FFC749"
              style={{ cursor: "pointer" }}
              onClick={() => this.toggleColor("gold", filters)}
            ...
            <path
              fill="#388540"
              style={{ cursor: "pointer" }}
              onClick={() => this.toggleColor("darkgreen", filters)}
              d="M52.2,52.2L25.6,25.6C14.8,36.5,7,50.1,3,64.9l36.2,9.7C41.5,66.1,46,58.4,52.2,52.2z"
            />
            <path
              fill="#438C97"
              style={{ cursor: "pointer" }}
              onClick={() => this.toggleColor("lightblue", filters)}
            ...
            <path
              fill="#BCCC46"
              style={{ cursor: "pointer" }}
              onClick={() => this.toggleColor("lightgreen", filters)}
              d="M3,64.9c-3.9,14.4-4.1,29.9,0,45.3l36.2-9.7c-2.4-8.8-2.2-17.7,0-25.9L3,64.9z"
            />
            <path
              fill="#FBE854"
              style={{ cursor: "pointer" }}
              onClick={() => this.toggleColor("yellow", filters)}
