import { RegisterValidTestQueryResponse } from "__generated__/RegisterValidTestQuery.graphql"
...
const setupTestEnv = () => {
  return createTestEnv({
    ...
    `,
    defaultData: RegisterQueryResponseFixture as RegisterValidTestQueryResponse,
