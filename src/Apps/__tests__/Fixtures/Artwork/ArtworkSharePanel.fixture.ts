export const ArtworkSharePanelFixture = {
  artwork: {
    ...
    artworkMeta: {
      description:
        "Available for sale from Gallery Art, Andy Warhol, LENIN FS II.402 (1987), SCREENPRINT ON ARCHES 88 PAPER, 43 1/8 × 30 1/2 in",
    },
  },
}
