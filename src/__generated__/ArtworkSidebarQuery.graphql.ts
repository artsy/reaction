...
fragment ArtworkSidebar_artwork on Artwork {
  is_in_auction
  ...ArtworkSidebarArtists_artwork_2uFK4Q
...
fragment ArtworkSidebarArtists_artwork_2uFK4Q on Artwork {
  artists {
    __id
    id
    name
    href
    ...FollowArtistButton_artist_2uFK4Q
  }
  __id
}
...
fragment FollowArtistButton_artist_2uFK4Q on Artist {
  __id
  id
  is_followed
  counts {
