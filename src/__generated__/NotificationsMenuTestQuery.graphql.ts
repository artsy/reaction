...
export type NotificationsMenuTestQueryVariables = {};
export type NotificationsMenuTestQueryResponse = {
    readonly me: {
...
export type NotificationsMenuTestQuery = {
    readonly response: NotificationsMenuTestQueryResponse;
    readonly variables: NotificationsMenuTestQueryVariables;
};
...
return {
  ...
  "fragment": {
    "kind": "Fragment",
    "name": "NotificationsMenuTestQuery",
    "type": "Query",
    "metadata": null,
    "argumentDefinitions": [],
    "selections": [
  ...
  "params": {
    ...
    "name": "NotificationsMenuTestQuery",
    "id": null,
    "text": "query NotificationsMenuTestQuery {\n  me {\n    followsAndSaves {\n      notifications: bundledArtworksByArtistConnection(sort: PUBLISHED_AT_DESC, first: 10) {\n        edges {\n          node {\n            href\n            summary\n            artists\n            published_at: publishedAt(format: \"MMM DD\")\n            image {\n              resized(height: 40, width: 40) {\n                url\n              }\n            }\n            id\n            __typename\n          }\n          cursor\n        }\n        pageInfo {\n          endCursor\n          hasNextPage\n        }\n      }\n    }\n    id\n  }\n}\n",
    "metadata": {
      "connection": [
        {
          "count": null,
...
(node as any).hash = '1194216a881243c3270f81ecfd86a6cb';
export default node;
