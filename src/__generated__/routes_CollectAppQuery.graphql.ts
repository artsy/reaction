...
query routes_CollectAppQuery(
  ...
  viewer {
    ...CollectApp_viewer_2zigIJ
  }
}

fragment CollectApp_viewer_2zigIJ on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    ...SeoProductsForArtworks_artworks
    __id
  }
  ...CollectFilterContainer_viewer_2zigIJ
}
...
fragment CollectFilterContainer_viewer_2zigIJ on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    aggregations {
      slice
      counts {
  ...
  ...CollectRefetch_viewer_2zigIJ
}

fragment CollectRefetch_viewer_2zigIJ on Viewer {
  filtered_artworks: filter_artworks(aggregations: [TOTAL], medium: $medium, major_periods: $major_periods, partner_id: $partner_id, for_sale: $for_sale, at_auction: $at_auction, acquireable: $acquireable, offerable: $offerable, inquireable_only: $inquireable_only, size: 0, sort: $sort, price_range: $price_range, artist_id: $artist_id, attribution_class: $attribution_class) {
...
(node as any).hash = '964d37224fe46ea28d293559f714400b';
export default node;
