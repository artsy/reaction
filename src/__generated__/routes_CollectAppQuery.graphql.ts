...
query routes_CollectAppQuery(
  ...
  viewer {
    ...CollectApp_viewer_ASxs4
  }
}

fragment CollectApp_viewer_ASxs4 on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    ...SeoProductsForArtworks_artworks
    __id
  }
  ...CollectFilterContainer_viewer_4m5bgH
}
...
fragment CollectFilterContainer_viewer_4m5bgH on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    aggregations {
      slice
      counts {
  ...
  ...CollectRefetch_viewer_4m5bgH
}

fragment CollectRefetch_viewer_4m5bgH on Viewer {
  filtered_artworks: filter_artworks(aggregations: [TOTAL], medium: $medium, major_periods: $major_periods, partner_id: $partner_id, for_sale: $for_sale, at_auction: $at_auction, acquireable: $acquireable, offerable: $offerable, inquireable_only: $inquireable_only, size: 0, sort: $sort, price_range: $price_range, height: $height_range, artist_id: $artist_id, attribution_class: $attribution_class, color: $color) {
...
(node as any).hash = '734e41ac7ecb29c1e9b1c43eebed0cd6';
export default node;
