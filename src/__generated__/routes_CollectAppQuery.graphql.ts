...
fragment CollectFilterContainer_viewer_1SHf1E on Viewer {
  ...
  ...CollectRefetch_viewer_2voMzX
}

fragment CollectRefetch_viewer_2voMzX on Viewer {
  filtered_artworks: filter_artworks(aggregations: [TOTAL], medium: $medium, major_periods: $major_periods, partner_id: $partner_id, for_sale: $for_sale, at_auction: $at_auction, acquireable: $acquireable, inquireable_only: $inquireable_only, size: 0, sort: $sort, price_range: $price_range, artist_id: $artist_id) {
