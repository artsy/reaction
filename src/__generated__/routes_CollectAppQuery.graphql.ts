...
query routes_CollectAppQuery(
  ...
  viewer {
    ...CollectApp_viewer_1jUhVe
  }
}

fragment CollectApp_viewer_1jUhVe on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    ...SeoProductsForArtworks_artworks
    __id
  }
  ...CollectFilterContainer_viewer_1jUhVe
}
...
fragment CollectFilterContainer_viewer_1jUhVe on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    aggregations {
      slice
      counts {
  ...
  ...CollectRefetch_viewer_1jUhVe
}

fragment CollectRefetch_viewer_1jUhVe on Viewer {
...
(node as any).hash = '4e556349bf7adc50a0bd7b8538df97af';
export default node;
