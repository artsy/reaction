...
export type routes_MarketingCollectionApp2Query = {
    readonly response: routes_MarketingCollectionApp2QueryResponse;
    readonly variables: routes_MarketingCollectionApp2QueryVariables;
};
...
query routes_MarketingCollectionApp2Query(
  ...
  viewer: marketingCollection(slug: $slug) {
    ...Collection_viewer_2VoSIu
    __id: id
  }
}

fragment Collection_viewer_2VoSIu on MarketingCollection {
  id
  slug
  title
  description
  ...
  ...CollectionArtworkFilter_viewer_3tWJc4
  __id: id
}
...
fragment CollectionHeader_artworks on FilterArtworks {
...
fragment CollectionArtworkFilter_viewer_3tWJc4 on MarketingCollection {
  artworks(aggregations: [MERCHANDISABLE_ARTISTS, MEDIUM, MAJOR_PERIOD, TOTAL], include_medium_filter_in_aggregation: true, sort: "-decayed_merch", size: 12) {
    aggregations {
      slice
      counts {
  ...
  slug
  filteredArtworks: artworks(acquireable: $acquireable, aggregations: [TOTAL], at_auction: $at_auction, color: $color, for_sale: $for_sale, height: $height, inquireable_only: $inquireable_only, major_periods: $major_periods, medium: $medium, offerable: $offerable, page: $page, price_range: $price_range, size: 0, sort: $sort, width: $width) {
...
return {
  "kind": "Request",
  "operationKind": "query",
  "name": "routes_MarketingCollectionApp2Query",
  "id": null,
...
(node as any).hash = '58d473ad4b7ea9fd55206c0993d313f4';
export default node;
