...
fragment Collection_collection_3tWJc4 on MarketingCollection {
  ...
  ...CollectionArtworkFilter_collection_3tWJc4
  __id: id
}
...
fragment CollectionArtworkFilter_collection_3tWJc4 on MarketingCollection {
  artworks(aggregations: [MERCHANDISABLE_ARTISTS, MEDIUM, MAJOR_PERIOD, TOTAL], include_medium_filter_in_aggregation: true, sort: "-decayed_merch", size: 12) {
    aggregations {
      slice
      counts {
  ...
  slug
  filtered_artworks: artworks(aggregations: [TOTAL], medium: $medium, major_periods: $major_periods, partner_id: $partner_id, for_sale: $for_sale, at_auction: $at_auction, acquireable: $acquireable, offerable: $offerable, inquireable_only: $inquireable_only, size: 0, sort: $sort, price_range: $price_range, height: $height, width: $width, color: $color, page: $page) {
