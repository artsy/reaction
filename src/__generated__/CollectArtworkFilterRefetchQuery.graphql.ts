...
query CollectArtworkFilterRefetchQuery(
  ...
  viewer {
    ...CollectArtworkFilterRefetch_viewer_1Zly9L
  }
}

fragment CollectArtworkFilterRefetch_viewer_1Zly9L on Viewer {
  filtered_artworks: filter_artworks(aggregations: [TOTAL], medium: $medium, major_periods: $major_periods, partner_id: $partner_id, for_sale: $for_sale, at_auction: $at_auction, acquireable: $acquireable, inquireable_only: $inquireable_only, size: 0, sort: $sort) {
...
(node as any).hash = '02d4de7e037a8b76fbc10cb9a0811409';
export default node;
