...
export type ArtworkFilterArtworkGrid2Query = {
    readonly response: ArtworkFilterArtworkGrid2QueryResponse;
    readonly variables: ArtworkFilterArtworkGrid2QueryVariables;
};
...
(node as any).hash = 'f6d41f6f12d82285470e7bab82df05b9';
export default node;
