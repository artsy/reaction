...
export type CollectionRefetchQuery = {
    readonly response: CollectionRefetchQueryResponse;
    readonly variables: CollectionRefetchQueryVariables;
};
...
query CollectionRefetchQuery(
  ...
  marketingCollection(slug: $collectionSlug) {
    ...CollectionRefetch_collection_2VoSIu
    __id: id
  }
}

fragment CollectionRefetch_collection_2VoSIu on MarketingCollection {
  slug
...
(node as any).hash = '0e8ef4750a583918263c1545c899507c';
export default node;
