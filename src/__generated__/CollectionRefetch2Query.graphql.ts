...
fragment Collection_collection_2Pwt5i on MarketingCollection {
  ...
  descending_artworks: artworksConnection(aggregations: $aggregations, includeMediumFilterInAggregation: true, first: 1, sort: "sold,-has_price,-prices") {
...
(node as any).hash = 'bbf010908e144d8528bf75598446c58f';
export default node;
