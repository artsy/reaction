...
query ArtworkFilterRefetchQuery(
  ...
  node(__id: $artistNodeID) {
    __typename
    ... on Artist {
      ...ArtworkFilterRefetch_artist_4f9RuC
    }
    __id
  }
}

fragment ArtworkFilterRefetch_artist_4f9RuC on Artist {
  __id
  grid: filtered_artworks(aggregations: [TOTAL], medium: $medium, major_periods: $major_periods, partner_id: $partner_id, for_sale: $for_sale, at_auction: $at_auction, acquireable: $acquireable, size: 0, sort: $sort) {
...
(node as any).hash = '9dc31150e1f90c5e7cb5b368a10b579f';
export default node;
