...
fragment ArtworkFilter_artist_3vi6l5 on Artist {
  id
  filtered_artworks(aggregations: [MEDIUM, TOTAL, GALLERY, INSTITUTION, MAJOR_PERIOD], medium: $medium, major_periods: $major_periods, partner_id: $partner_id, for_sale: $for_sale, size: 0, sort: $sort) {
    aggregations {
      slice
      counts {
        name
...
(node as any).hash = 'd5391dbb4b448c5aebdc92720a0d7868';
export default node;
