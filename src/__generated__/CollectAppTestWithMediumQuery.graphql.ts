...
fragment CollectApp_viewer on Viewer {
  ...
  ...CollectFilterContainer_viewer_25KC4G
}
...
fragment CollectFilterContainer_viewer_25KC4G on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    aggregations {
      slice
      counts {
  ...
  ...CollectRefetch_viewer_25KC4G
}

fragment CollectRefetch_viewer_25KC4G on Viewer {
