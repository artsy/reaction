...
fragment CollectApp_viewer on Viewer {
  ...
  ...CollectFilterContainer_viewer_1cK26l
}
...
fragment CollectFilterContainer_viewer_1cK26l on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    aggregations {
      slice
      counts {
  ...
  ...CollectRefetch_viewer_1cK26l
}

fragment CollectRefetch_viewer_1cK26l on Viewer {
