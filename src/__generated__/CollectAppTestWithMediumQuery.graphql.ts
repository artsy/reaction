...
fragment CollectApp_viewer on Viewer {
  ...
  ...CollectFilterContainer_viewer_djR1u
}
...
fragment CollectFilterContainer_viewer_djR1u on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    aggregations {
      slice
      counts {
  ...
  ...CollectRefetch_viewer_djR1u
}

fragment CollectRefetch_viewer_djR1u on Viewer {
