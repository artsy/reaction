...
fragment CollectApp_viewer on Viewer {
  ...
  ...CollectFilterContainer_viewer_2RIzzW
}
...
fragment CollectFilterContainer_viewer_2RIzzW on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    aggregations {
      slice
      counts {
  ...
  ...CollectRefetch_viewer_2RIzzW
}

fragment CollectRefetch_viewer_2RIzzW on Viewer {
