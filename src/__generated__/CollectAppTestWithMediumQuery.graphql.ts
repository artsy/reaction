...
fragment CollectApp_viewer on Viewer {
  ...
  ...CollectFilterContainer_viewer_1KjEgs
}
...
fragment CollectFilterContainer_viewer_1KjEgs on Viewer {
  filter_artworks(aggregations: [MEDIUM, TOTAL], size: 0) {
    aggregations {
      slice
      counts {
  ...
  ...CollectRefetch_viewer_1KjEgs
}

fragment CollectRefetch_viewer_1KjEgs on Viewer {
