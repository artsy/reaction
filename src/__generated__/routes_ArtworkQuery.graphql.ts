...
export type routes_ArtworkQueryVariables = {
    ...
    readonly showFollowSuggestions: boolean;
};
...
query routes_ArtworkQuery(
  ...
  artwork(id: $artworkID) {
    ...ArtworkApp_artwork_2Pgc1
    __id
  }
}

fragment ArtworkApp_artwork_2Pgc1 on Artwork {
  id
  artist {
    id
    __id
...
fragment ArtworkSidebar_artwork_2Pgc1 on Artwork {
  is_in_auction
  ...ArtworkSidebarArtists_artwork_2Pgc1
...
fragment ArtworkSidebarArtists_artwork_2Pgc1 on Artwork {
  artists {
    __id
    id
    name
    href
    ...FollowArtistButton_artist_2Pgc1
  }
  __id
}
...
fragment FollowArtistButton_artist_2Pgc1 on Artist {
  __id
  id
  is_followed
  counts {
...
(node as any).hash = '31d22dcd8279c43604c004229780ae06';
export default node;
