...
export type OverviewQueryRawResponse = {
    readonly artist: ({
...
export type OverviewQuery = {
    ...
    readonly rawResponse: OverviewQueryRawResponse;
};
...
fragment Overview_artist_2c4z0P on Artist {
  ...ArtistBio_bio
  ...CurrentEvent_artist
...
(node as any).hash = '106100ca82a3843f6cf3f8aa52a6fd9c';
export default node;
