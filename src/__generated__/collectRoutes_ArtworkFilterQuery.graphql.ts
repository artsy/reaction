...
query collectRoutes_ArtworkFilterQuery(
  ...
  filterArtworks: artworksConnection(aggregations: $aggregations, sort: $sort) {
...
fragment ArtworkFilter_viewer_2c4z0P on Viewer {
  filtered_artworks: artworksConnection(acquireable: $acquireable, aggregations: $aggregations, artistID: $artistID, atAuction: $atAuction, attributionClass: $attributionClass, color: $color, forSale: $forSale, height: $height, inquireableOnly: $inquireableOnly, keyword: $keyword, majorPeriods: $majorPeriods, medium: $medium, offerable: $offerable, page: $page, partnerID: $partnerID, priceRange: $priceRange, size: 0, sort: $sort, width: $width) {
    id
...
(node as any).hash = '58e5367286d59b99cb97572aada6314e';
export default node;
