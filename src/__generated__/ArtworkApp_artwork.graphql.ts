...
export type ArtworkApp_artwork = {
    ...
    readonly " $fragmentRefs": ArtworkSidebar_artwork$ref & ArtworkDetails_artwork$ref & ArtworkImages_artwork$ref;
...
(node as any).hash = '77786833f4235abbfa068f7b2943ee05';
export default node;
