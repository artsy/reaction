...
fragment CollectionApp_collection_3tWJc4 on MarketingCollection {
  ...
  artworks(aggregations: [MERCHANDISABLE_ARTISTS, MEDIUM, MAJOR_PERIOD, TOTAL], include_medium_filter_in_aggregation: true, sort: "-merchandisability") {
    ...Header_artworks
    ...
    "selections": [
      {
        ...
        "selections": [
          ...
          },
          {
            ...
            "alias": null,
            "name": "artworks",
            "storageKey": "artworks(aggregations:[\"MERCHANDISABLE_ARTISTS\",\"MEDIUM\",\"MAJOR_PERIOD\",\"TOTAL\"],include_medium_filter_in_aggregation:true,sort:\"-merchandisability\")",
            "args": [
              {
                "kind": "Literal",
                "name": "aggregations",
