...
fragment CollectionApp_collection_3tWJc4 on MarketingCollection {
  ...
  artworks(aggregations: [MERCHANDISABLE_ARTISTS, MEDIUM, MAJOR_PERIOD, TOTAL], include_medium_filter_in_aggregation: true, sort: "-decayed_merch") {
    ...Header_artworks
    ...
    "selections": [
      {
        ...
        "selections": [
          ...
          },
          {
            ...
            "alias": null,
            "name": "artworks",
            "storageKey": "artworks(aggregations:[\"MERCHANDISABLE_ARTISTS\",\"MEDIUM\",\"MAJOR_PERIOD\",\"TOTAL\"],include_medium_filter_in_aggregation:true,sort:\"-decayed_merch\")",
            "args": [
              {
                "kind": "Literal",
                "name": "aggregations",
