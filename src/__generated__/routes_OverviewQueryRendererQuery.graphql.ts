...
fragment ArtworkFilter_artist on Artist {
  id
  filtered_artworks(aggregations: [MEDIUM, TOTAL, GALLERY, INSTITUTION, MAJOR_PERIOD], medium: "*", size: 0, sort: "-partner_updated_at") {
    aggregations {
      slice
      counts {
        name
    ...
    "selections": [
      {
        ...
        "selections": [
          ...
          },
          {
            ...
            "storageKey": "filtered_artworks(aggregations:[\"MEDIUM\",\"TOTAL\",\"GALLERY\",\"INSTITUTION\",\"MAJOR_PERIOD\"],medium:\"*\",size:0,sort:\"-partner_updated_at\")",
            "args": [
              {
                "kind": "Literal",
                "name": "aggregations",
