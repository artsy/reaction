...
export class IconOrderedList extends Component<any, null> {
  static defaultProps = {
    color: "black",
  }
  ...
  render() {
    return (
      <svg className='IconOrderedList' x="0px" y="0px" viewBox="-297 389.3 15.7 15.7" enableBackground="new -297 389.3 15.7 15.7" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g>
        ...
        <rect x="-291.5" y="390.9" fill={this.props.color} width="10.2" height="1.3" />
        <rect x="-291.5" y="396.5" fill={this.props.color} width="10.2" height="1.3" />
        <rect x="-291.5" y="402.1" fill={this.props.color} width="10.2" height="1.3" />
      </svg>
    )
  }
}
