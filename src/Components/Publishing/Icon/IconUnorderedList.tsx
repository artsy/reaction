...
export class IconUnorderedList extends Component<any, null> {
  ...
  render() {
    return (
      <svg className='IconUnorderedList' x="0px" y="0px" viewBox="-297 389.3 15.7 15.7" enableBackground="new -297 389.3 15.7 15.7" version="1.1" xmlns="http://www.w3.org/2000/svg">
