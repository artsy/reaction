...
describe("GeneRelatedLinks", () => {
  ...
  it("should render related genes and related artists", async () => {
    ...
    expect(wrapper.html()).toMatchInlineSnapshot(
      `"<div class=\\"sc-AxjAm ciStbw related-genes related-links bisected-header-cell-section is-fade-in\\"><h2>Related Categories</h2><div class=\\"related-genes-links\\"><a href=\\"https://www.artsy.net/artwork/david-shrigley-im-dead\\">meow</a></div></div>"`
    )
  })
