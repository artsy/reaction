...
function generateStory(imageCount: number) {
  const src = (value: string) => [...new Array(imageCount)].map(() => value)
  return () => {
    return (
      <React.Fragment>
        <Section title="Short portrait">
          <Col sm="8">
            <ImageCarousel src={src("https://picsum.photos/300/400/?random")} />
          </Col>
        </Section>
        <Section title="Tall portrait">
          <Col sm="8">
            <ImageCarousel
              src={src("https://picsum.photos/400/2000/?random")}
            />
          </Col>
        </Section>
        <Section title="Narrow landscape">
          <Col sm="8">
            <ImageCarousel src={src("https://picsum.photos/500/400/?random")} />
          </Col>
        </Section>
        <Section title="Wide landscape">
          <Col sm="8">
            <ImageCarousel
              src={src("https://picsum.photos/2000/400/?random")}
            />
          </Col>
        </Section>
      </React.Fragment>
